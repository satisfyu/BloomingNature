...
public class BloomingNatureRegion extends Region {

    public BloomingNatureRegion(ResourceLocation name, int weight) {
    ...
    public void addBiomes(Registry<Biome> registry, Consumer<Pair<Climate.ParameterPoint, ResourceKey<Biome>>> mapper) {
        addModifiedVanillaOverworldBiomes(mapper, builder -> {
            ...
            larchforestPoints.forEach(point -> builder.replaceBiome(point, BloomingNatureSurfaceRules.LARCH_FOREST_KEY));
        });
    ...
    public static void loadTerrablender() {
        Regions.register(new BloomingNatureRegion(new ResourceLocation(BloomingNature.MOD_ID, "overworld"), 5));
