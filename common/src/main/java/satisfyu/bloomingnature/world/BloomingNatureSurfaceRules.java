...
public class BloomingNatureSurfaceRules {
    ...
    private static ResourceKey<Biome> createBiomeKey(String name) {
        return ResourceKey.create(Registries.BIOME, new ResourceLocation(BloomingNature.MOD_ID, name));
    }
    ...
    private static ResourceKey<NormalNoise.NoiseParameters> register(String name) {
        return ResourceKey.create(Registries.NOISE, new ResourceLocation(BloomingNature.MOD_ID, name));
    }
}