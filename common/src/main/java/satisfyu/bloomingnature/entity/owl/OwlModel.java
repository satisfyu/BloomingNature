...
public class OwlModel extends AgeableListModel<OwlEntity> implements HeadedModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition head = head_connection.addOrReplaceChild("head", CubeListBuilder.create()
                        .texOffs(0, 16).addBox(-4.0F, -6.0F, -3.0F, 8.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, 0.0F));

        PartDefinition beak_lower = head.addOrReplaceChild("beak_lower", CubeListBuilder.create()
                        .texOffs(4, 5).addBox(-2.1F, -14.5F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offset(1.5F, 11.5F, 1.0F));

        PartDefinition brow_left = head.addOrReplaceChild("brow_left", CubeListBuilder.create().texOffs(11, 28).addBox(0.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, -5.5F, -3.5F));

        PartDefinition brow_right = head.addOrReplaceChild("brow_right", CubeListBuilder.create().texOffs(11, 30).addBox(-4.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, -5.5F, -3.5F));
